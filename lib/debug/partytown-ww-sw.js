/* Partytown 0.10.1-dev1722989109932 - MIT builder.io */
(self => {
    ...
    const getPartytownScript = () => `<script src="${partytownLibUrl("partytown.js?v=0.10.1-dev1722989109932")}"><\/script>`;
                    ...
                    if (!hasInitializedMedia) {
                        (() => {
                            if (!webWorkerCtx.$initWindowMedia$) {
                                ...
                                webWorkerCtx.$importScripts$(partytownLibUrl("partytown-media.js?v=0.10.1-dev1722989109932"));
